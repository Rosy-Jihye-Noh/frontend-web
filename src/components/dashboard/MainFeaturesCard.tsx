...
const MainFeaturesCard: React.FC<MainFeaturesCardProps> = ({ onPostureAnalysis, onWorkoutRecommend }) => (
  <div className="md:col-span-2 flex flex-col justify-between items-center p-6 shadow-lg rounded-lg">
    ...
    <div className="grid grid-cols-2 gap-6 w-full">
      <Button onClick={onPostureAnalysis} className="flex flex-col items-center p-6 min-h-[120px] bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition shadow cursor-pointer">
      ...
      <Button onClick={onWorkoutRecommend} className="flex flex-col items-center p-6 min-h-[120px] bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition shadow cursor-pointer">
